...
namespace Cristea_Anamaria_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Cristea_Anamaria_Lab8Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Cristea_Anamaria_Lab8Context context,
